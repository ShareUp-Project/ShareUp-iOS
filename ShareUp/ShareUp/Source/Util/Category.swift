...
enum Category: String {
    case defaultBadge = "defaultBadge"
    case first = "first"
    case paper1 = "paper1"
    case paper2 = "paper2"
    case paper3 = "paper3"
...
extension Category {
    func toDescription() -> [String] {
        ...
        case .vinyl2:
            return ["깨긋한 비닐", "뭐라고요? 비닐 새활용을 10개나 했다고요? 잘했어요. 앞으로도 계속 해주세요!", "(비닐 카테고리 게시물 10개 이상 작성 시 달성)"]
        case .can1:
        ...
        case .glass3:
            return ["친환경 유리", " ", "(유리 카테고리 게시물 20개 이상 작성 시 달성)"]
        case .styrofoam1:
